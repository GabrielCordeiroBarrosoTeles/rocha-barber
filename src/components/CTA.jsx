  ...
  return (
    <section className="w-full py-16 bg-gradient-to-r from-amber-600 to-amber-700 text-white">
      <div className="container px-4 mx-auto text-center">
        <h2 className="text-3xl md:text-4xl font-bold mb-6 drop-shadow-md">Pronto para renovar seu visual?</h2>
        ...
        >
          <Button variant="white" className="text-lg px-8 py-3 h-auto font-semibold">
