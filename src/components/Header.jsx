      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          ...
          <nav className="hidden md:flex items-center space-x-6">
            <a href="#inicio" className="hover:text-amber-400 transition-colors relative group">
              Início
              <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-amber-400 transition-all duration-300 group-hover:w-full"></span>
            </a>
            <a href="#servicos" className="hover:text-amber-400 transition-colors relative group">
              Serviços
              <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-amber-400 transition-all duration-300 group-hover:w-full"></span>
            </a>
            <a href="#sobre" className="hover:text-amber-400 transition-colors relative group">
              Sobre
              <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-amber-400 transition-all duration-300 group-hover:w-full"></span>
            </a>
            <a href="#contato" className="hover:text-amber-400 transition-colors relative group">
              Contato
              <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-amber-400 transition-all duration-300 group-hover:w-full"></span>
            </a>
            <a href="#servicos">
      ...
      {isMenuOpen && (
        <nav className="md:hidden bg-zinc-800 py-4 animate-fadeIn">
          <div className="container mx-auto px-4 flex flex-col space-y-3">
            <a href="#inicio" className="py-2 hover:text-amber-400 transition-colors" onClick={toggleMenu}>
              Início
            </a>
            <a href="#servicos" className="py-2 hover:text-amber-400 transition-colors" onClick={toggleMenu}>
              Serviços
            </a>
            <a href="#sobre" className="py-2 hover:text-amber-400 transition-colors" onClick={toggleMenu}>
              Sobre
            </a>
